...
let initialState = {
    users: [
        ...
        { id: 1, followed: true, name: 'Dmitry K.', loc: 'Minsk, Belarus', status: 'Im looking for someone...' },
        { id: 2, followed: true, name: 'Dmitry K.', loc: 'Minsk, Belarus', status: 'Im looking for someone...' }
    ]
}
